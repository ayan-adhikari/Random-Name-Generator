...
const names = {
  ...
  "Owen", "Diego", "Carlos", "Jesus", "Adrian", "Ivan", "Jaden", "Jayden",
  ...
  "Ava", "Sophia", "Isabella", "Mia", "Charlotte", "Olivia", "Abigail",
  ...
  "Penelope", "Ruby", "Scarlett", "Sofia", "Sydney", "Trinity"
    ...
    surnames: [
  "Smith", "Brown", "Johnson",
  "Williams", "Jones", "Garcia", "Miller", "Davis", "Rodriguez", "Martinez",
  ...
  "Kennedy", "Wells", "Vargas", "Henry", "Chen", "Freeman", "Mayo", "Simpson",
  "Palmer", "Holmes", "Stone", "Mills", "Nichols", "Grant", "Knight", "Ferguson",
  "Rose", "Hawkins", "Dunn", "Spencer", "Hudson", "Arnold", "Wagner", "Willis",
  "Ray", "Watkins", "Olson", "Carroll", "Duncan", "Snyder", "Hart", "Porter",
  "Hunter", "Hicks", "Weaver", "Fox", "Bryan", "Riley", "Shaw", "Gordon",
  "Holmes", "Rice", "Robertson", "French", "Chapman", "Lawrence", "Garner",
  "Beck", "Bishop", "Mason", "Day", "Dean", "Schmidt", "George", "Daniels",
  "Franklin", "Lawson", "Carr", "Little", "Meyer", "Harmon", "Weber", "Larson",
  "Carlson", "Harper", "George", "Greene", "Burke", "Ortiz", "Castillo", "Soto", 
]
  },
  fantasy: {
    firstNames: [
